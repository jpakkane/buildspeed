...
#ifndef NMROOT_H_1416321839
#define NMROOT_H_1416321839
 ...
 */
class NetworkManagerRoot: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    NetworkManagerRoot(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QDBusObjectPath, QDBusObjectPath> AddAndActivateConnection(const QVariantDictMap &connection, const QDBusObjectPath &device, const QDBusObjectPath &specific_object)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(connection) << QVariant::fromValue(device) << QVariant::fromValue(specific_object);
        return asyncCallWithArgumentList(QLatin1String("AddAndActivateConnection"), argumentList);
    }
    inline QDBusReply<QDBusObjectPath> AddAndActivateConnection(const QVariantDictMap &connection, const QDBusObjectPath &device, const QDBusObjectPath &specific_object, QDBusObjectPath &active_connection)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(connection) << QVariant::fromValue(device) << QVariant::fromValue(specific_object);
